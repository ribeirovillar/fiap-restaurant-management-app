...
public class RestaurantJpaGateway implements RestaurantGateway {
    ...
    public Restaurant update(Restaurant restaurant) {
        ...
        RestaurantEntity existingEntity = restaurantRepository.findById(restaurant.getId()).orElseThrow();

        RestaurantEntity entity = restaurantPresenter.toEntity(restaurant, existingEntity);
        restaurantPresenter.updateBusinessHours(entity, restaurant.getBusinessHours());
